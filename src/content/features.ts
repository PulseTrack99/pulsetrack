...
const en: Catalog = {
  ...
  heatmaps: {
    ...
    faq: [
      ...
      },
      {
        ...
        a: "The whole PulseTrack script is 3.4 KB gzipped and loads with defer, so it never blocks rendering. Heatmap collection adds no additional request.",
      },
      {
  ...
  privacy: {
    ...
    highlights: [
      ...
      {
        title: "42× lighter",
        body: "3.4 KB against 144 KB for GA4's gtag.js, both gzipped. That is a measurable Core Web Vitals difference on mobile.",
      },
    ],
    steps: [
      {
...
const fr: Catalog = {
  ...
  heatmaps: {
    ...
    faq: [
      ...
      },
      {
        ...
        a: "L'ensemble du script PulseTrack pèse 3,4 Ko gzippé et se charge en defer : il ne bloque jamais le rendu. La collecte des heatmaps n'ajoute aucune requête.",
      },
      {
  ...
  privacy: {
    ...
    highlights: [
      ...
      {
        title: "42× plus léger",
        body: "3,4 Ko contre 144 Ko pour le gtag.js de GA4, tous deux gzippés. C'est une différence mesurable sur les Core Web Vitals en mobile.",
      },
    ],
    steps: [
      {
