...
const en: Catalog = {
  ...
  heatmaps: {
    ...
    faq: [
      ...
      },
      {
        ...
        a: "The whole PulseTrack script is 2.8 KB and loads with defer, so it never blocks rendering. Heatmap collection adds no additional request.",
      },
      {
  ...
  privacy: {
    ...
    subtitle:
      "PulseTrack never sets a cookie and never stores personal data, so there is nothing to ask consent for — and 16× less weight on every page load.",
    metaTitle: "Cookie-free, GDPR-native web analytics",
    metaDescription:
      "Analytics with no cookies, no personal data and no consent banner. GDPR, ePrivacy and CCPA compliant by architecture, hosted in the EU, 2.8 KB script.",
    highlights: [
      {
      ...
      {
        title: "16× lighter",
        body: "2.8 KB against roughly 45 KB for GA4. That is a measurable Core Web Vitals difference on mobile.",
      },
    ],
    steps: [
      {
...
const fr: Catalog = {
  ...
  heatmaps: {
    ...
    faq: [
      ...
      },
      {
        ...
        a: "L'ensemble du script PulseTrack pèse 2,8 Ko et se charge en defer : il ne bloque jamais le rendu. La collecte des heatmaps n'ajoute aucune requête.",
      },
      {
  ...
  privacy: {
    ...
    subtitle:
      "PulseTrack ne pose jamais de cookie et ne stocke aucune donnée personnelle : il n'y a rien à faire consentir — et 16× moins de poids sur chaque chargement.",
    metaTitle: "Analytics web sans cookie et conforme RGPD",
    metaDescription:
      "Un analytics sans cookie, sans donnée personnelle et sans bannière de consentement. Conforme RGPD, ePrivacy et CCPA par conception, hébergé en Europe, script de 2,8 Ko.",
    highlights: [
      {
      ...
      {
        title: "16× plus léger",
        body: "2,8 Ko contre environ 45 Ko pour GA4. C'est une différence mesurable sur les Core Web Vitals en mobile.",
      },
    ],
    steps: [
      {
