...
const en: Catalog = {
  ...
  heatmaps: {
    ...
    faq: [
      ...
      },
      {
        ...
        a: "The whole PulseTrack script is 3.6 KB gzipped and loads with defer, so it never blocks rendering. Heatmap collection adds no additional request.",
      },
      {
  ...
  privacy: {
    ...
    subtitle:
      "PulseTrack never sets a cookie and never stores personal data, so there is nothing to ask consent for — and 40× less weight on every page load.",
    metaTitle: "Cookie-free, GDPR-native web analytics",
    metaDescription:
      "Analytics with no cookies, no personal data and no consent banner. GDPR, ePrivacy and CCPA compliant by architecture, hosted in the EU, 3.6 KB gzipped script.",
    highlights: [
      {
      ...
      {
        title: "40× lighter",
        body: "3.6 KB against 144 KB for GA4's gtag.js, both gzipped. That is a measurable Core Web Vitals difference on mobile.",
      },
    ],
    steps: [
      {
...
const fr: Catalog = {
  ...
  heatmaps: {
    ...
    faq: [
      ...
      },
      {
        ...
        a: "L'ensemble du script PulseTrack pèse 3,6 Ko gzippé et se charge en defer : il ne bloque jamais le rendu. La collecte des heatmaps n'ajoute aucune requête.",
      },
      {
  ...
  privacy: {
    ...
    subtitle:
      "PulseTrack ne pose jamais de cookie et ne stocke aucune donnée personnelle : il n'y a rien à faire consentir — et 40× moins de poids sur chaque chargement.",
    metaTitle: "Analytics web sans cookie et conforme RGPD",
    metaDescription:
      "Un analytics sans cookie, sans donnée personnelle et sans bannière de consentement. Conforme RGPD, ePrivacy et CCPA par conception, hébergé en Europe, script de 3,6 Ko gzippé.",
    highlights: [
      {
      ...
      {
        title: "40× plus léger",
        body: "3,6 Ko contre 144 Ko pour le gtag.js de GA4, tous deux gzippés. C'est une différence mesurable sur les Core Web Vitals en mobile.",
      },
    ],
    steps: [
      {
