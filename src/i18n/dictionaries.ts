...
const en: Dictionary = {
  meta: {
    ...
    description:
      "See which traffic sources turn into paying customers, not just pageviews. Privacy-first web analytics with revenue attribution, heatmaps and funnels. Cookie-free, GDPR-native, 3.4 KB gzipped script.",
    keywords: [
      "web analytics",
      "revenue attribution",
  ...
  hero: {
    ...
    notes: ["No credit card", "GDPR-native", "3.4 KB script, gzipped"],
  },
  ...
  featurePrivacy: {
    ...
    bullets: [
      ...
      "42× lighter than Google Analytics",
    ],
...
const fr: Dictionary = {
  meta: {
    ...
    description:
      "Découvrez quelles sources de trafic deviennent des clients payants, pas juste des pages vues. Analytics respectueux de la vie privée avec attribution du revenu, heatmaps et funnels. Sans cookie, conforme RGPD, script de 3,4 Ko gzippé.",
    keywords: [
      "analytics web",
  ...
  hero: {
    ...
    notes: ["Sans carte bancaire", "RGPD natif", "Script de 3,4 Ko gzippé"],
  },
  ...
  featurePrivacy: {
    ...
    bullets: [
      ...
      "42× plus léger que Google Analytics",
    ],
