...
const en: Dictionary = {
  meta: {
    ...
    description:
      "See which traffic sources turn into paying customers, not just pageviews. Privacy-first web analytics with revenue attribution, heatmaps and funnels. Cookie-free, GDPR-native, 2.6 KB script.",
    keywords: [
      "web analytics",
      "revenue attribution",
  ...
  hero: {
    ...
    notes: ["No credit card", "GDPR-native", "2.6 KB script"],
  },
  ...
  featurePrivacy: {
    ...
    bullets: [
      ...
      "55× lighter than Google Analytics",
    ],
...
const fr: Dictionary = {
  meta: {
    ...
    description:
      "Découvrez quelles sources de trafic deviennent des clients payants, pas juste des pages vues. Analytics respectueux de la vie privée avec attribution du revenu, heatmaps et funnels. Sans cookie, conforme RGPD, script de 2,6 Ko.",
    keywords: [
      "analytics web",
  ...
  hero: {
    ...
    notes: ["Sans carte bancaire", "RGPD natif", "Script de 2,6 Ko"],
  },
  ...
  featurePrivacy: {
    ...
    bullets: [
      ...
      "55× plus léger que Google Analytics",
    ],
